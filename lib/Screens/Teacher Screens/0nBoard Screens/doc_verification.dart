      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            for (int i = 0; i < fileProvider.selectedFiles.length; i++)
              Card(
                        ...
                        children: [
                          SizedBox(
                              ...
                              child: AppText.appText(
                                  fileProvider.selectedFiles[i].file.name,
                                  fontSize: 16,
                          ...
                          Text(
                              "${(fileProvider.selectedFiles[i].file.size / 1024).toStringAsFixed(1)} KB"),
                        ],
                      ),
                      IconButton(
                        icon: Icon(Icons.delete, color: Colors.red),
                        onPressed: () => fileProvider.removeFile(i),
                      ),
                    ],
                  ),
                ),
